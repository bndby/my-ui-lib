...
Подробное описание команд и сценариев: [CLI.md](./CLI.md)

Описание структуры реестра шаблонов: [REGISTRY.md](./REGISTRY.md)
...
Подробнее о тестировании: [templates/README.tests.md](./templates/README.tests.md)
